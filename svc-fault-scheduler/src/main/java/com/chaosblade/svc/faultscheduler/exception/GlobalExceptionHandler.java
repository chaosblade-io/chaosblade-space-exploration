...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleKubernetesClientException(io.fabric8.kubernetes.client.KubernetesClientException e) {
        ...
        if (statusCode == 404) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(ApiResponse.error("K8S_RESOURCE_NOT_FOUND", "Resource not found in Kubernetes cluster"));
        } else if (statusCode == 403) {
            return ResponseEntity.status(HttpStatus.FORBIDDEN)
                    .body(ApiResponse.error("K8S_PERMISSION_DENIED", "Insufficient permissions for Kubernetes operation"));
    ...
    public ResponseEntity<ApiResponse<Void>> handleRedisConnectionFailureException(org.springframework.data.redis.RedisConnectionFailureException e) {
    ...
    public ResponseEntity<ApiResponse<Void>> handleFaultSchedulerException(FaultSchedulerException e) {
