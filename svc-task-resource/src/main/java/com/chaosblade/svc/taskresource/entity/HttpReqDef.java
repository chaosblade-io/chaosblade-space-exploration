 ...
 */
@Entity
@Table(name = "http_req_def", indexes = {
...
public class HttpReqDef {
    ...
    @AssertTrue(message = "When bodyMode is JSON or FORM, bodyTemplate must be provided; when RAW, rawBody must be provided; when NONE, both must be null")
