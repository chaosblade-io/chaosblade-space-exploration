...
public class TaskSloController {
    ...
    @Autowired
    private TaskSloService service;
    ...
    public ApiResponse<PageResponse<TaskSlo>> list(
        ...
        logger.info("GET /api/task-slos - p95: {}, p99: {}, errRate: {}, taskId: {}, nodeId: {}, page: {}, size: {}",
                p95, p99, errRate, taskId, nodeId, page, size);
    ...
    public ApiResponse<TaskSlo> create(@Valid @RequestBody TaskSlo slo) {
        logger.info("POST /api/task-slos - p95: {}, p99: {}, errRate: {}, taskId: {}, nodeId: {}",
                slo.getP95(), slo.getP99(), slo.getErrRate(), slo.getTaskId(), slo.getNodeId());
