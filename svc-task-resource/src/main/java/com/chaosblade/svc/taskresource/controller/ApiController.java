...
public class ApiController {
  ...
  /** 获取系统的API列表 GET /api/systems/{systemId}/apis */
  ...
  public ApiResponse<PageResponse<Api>> getSystemApis(
    ...
    logger.info(
        "GET /api/systems/{}/apis - method: {}, path: {}, tags: {}, version: {}, page: {}, size:"
            + " {}",
        systemId,
        method,
        path,
    ...
    PageResponse<Api> apis =
        apiService.getApisBySystemId(systemId, method, path, tags, version, page, size);
    return ApiResponse.success(apis);
  }

  /** 获取系统的特定API详情 GET /api/systems/{systemId}/apis/{operationId} */
  @GetMapping("/systems/{systemId}/apis/{operationId}")
  public ApiResponse<Api> getSystemApiByOperationId(
      @PathVariable Long systemId, @PathVariable String operationId) {
  ...
  /** 创建系统API POST /api/systems/{systemId}/apis */
  @PostMapping("/systems/{systemId}/apis")
  public ApiResponse<Api> createSystemApi(
      @PathVariable Long systemId, @Valid @RequestBody Api api) {
  ...
  /** 更新API信息 PUT /api/apis/{apiId} */
  @PutMapping("/apis/{apiId}")
  public ApiResponse<Api> updateApi(@PathVariable Long apiId, @Valid @RequestBody Api api) {
