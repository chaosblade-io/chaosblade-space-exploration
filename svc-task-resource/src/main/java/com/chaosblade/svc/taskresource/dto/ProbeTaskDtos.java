...
public class ProbeTaskDtos {
    ...
    public static class FaultConfigurationItem {
        ...
        public void setFaulscript(Map<String, Object> v) { this.faultscript = v; }
    }
    ...
    public static class ProbeTaskCreateResponse {
        ...
        public ProbeTaskCreateResponse(Long taskId, Long apiDefinitionId, int createdFaultConfigCount, int createdTaskSloCount) {
            this.taskId = taskId;
