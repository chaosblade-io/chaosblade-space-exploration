...
public class FaultTypeController {
  ...
  @Autowired private FaultTypeService faultTypeService;
  ...
  public ApiResponse<PageResponse<FaultType>> getFaultTypes(
    ...
    logger.info(
        "GET /api/fault-types - category: {}, severityLevel: {}, status: {}, name: {}, page: {},"
            + " size: {}",
        category,
        severityLevel,
        status,
    ...
    PageResponse<FaultType> faultTypes =
        faultTypeService.getFaultTypes(category, severityLevel, status, name, page, size);
    return ApiResponse.success(faultTypes);
  }

  /** 获取故障类型详情 GET /api/fault-types/{faultTypeId} */
  ...
  /** 根据名称获取故障类型详情 GET /api/fault-types/by-name/{name} */
  ...
  /** 更新故障类型信息 PUT /api/fault-types/{faultTypeId} */
  @PutMapping("/fault-types/{faultTypeId}")
  public ApiResponse<FaultType> updateFaultType(
      @PathVariable Long faultTypeId, @Valid @RequestBody FaultType faultType) {
  ...
  /** 删除故障类型 DELETE /api/fault-types/{faultTypeId} */
  ...
  /** 根据分类获取故障类型列表 GET /api/fault-types/category/{category} */
  ...
  /** 根据故障代码获取故障类型列表 GET /api/fault-types/code/{code} */
  ...
  /** 获取所有分类 GET /api/fault-types/categories */
  ...
  /** 获取分类统计信息 GET /api/fault-types/statistics/categories */
