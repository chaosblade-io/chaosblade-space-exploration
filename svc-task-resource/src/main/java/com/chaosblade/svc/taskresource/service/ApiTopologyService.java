...
public class ApiTopologyService {
    ...
    @Autowired
    private ApiTopologyRepository apiTopologyRepository;
    
    @Autowired
    private ApiTopologyNodeRepository apiTopologyNodeRepository;

    @Autowired
    private ApiTopologyEdgeRepository apiTopologyEdgeRepository;
    ...
    public PageResponse<ApiTopology> getTopologiesBySystemId(Long systemId, String sourceVersion, int page, int size) {
        logger.debug("Getting topologies for system: {}, sourceVersion: {}, page: {}, size: {}",
        ...
        Page<ApiTopology> topologyPage = apiTopologyRepository.findBySystemIdAndSourceVersion(systemId, sourceVersion, pageable);
    ...
    public ApiTopology getLatestTopologyBySystemId(Long systemId) {
        ...
        return apiTopologyRepository.findLatestBySystemId(systemId)
    ...
    public ApiTopology getTopologyById(Long topologyId) {
        ...
        return apiTopologyRepository.findById(topologyId)
    ...
    public ApiTopology createTopology(ApiTopology topology) {
        logger.info("Creating new topology for system: {} and api: {}", topology.getSystemId(), topology.getApiId());
        ...
        // 检查拓扑是否已存在
        if (apiTopologyRepository.existsBySystemIdAndApiId(topology.getSystemId(), topology.getApiId())) {
            throw new BusinessException("TOPOLOGY_EXISTS",
     ...
     */
    @Transactional(readOnly = true)
    public PageResponse<ApiTopologyNode> getTopologyNodes(Long topologyId, String protocol, String name,
                                                         Integer layer, int page, int size) {
        logger.debug("Getting nodes for topology: {}, protocol: {}, name: {}, layer: {}, page: {}, size: {}",
                    topologyId, protocol, name, layer, page, size);
        ...
        Page<ApiTopologyNode> nodePage = apiTopologyNodeRepository.findByTopologyId(topologyId, pageable);
