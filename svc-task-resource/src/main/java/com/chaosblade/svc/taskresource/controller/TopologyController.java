...
public class TopologyController {
    ...
    public ApiResponse<ApiTopology> updateTopology(@PathVariable Long topologyId,
    ...
    public ApiResponse<PageResponse<ApiTopologyNode>> getTopologyNodes(
        ...
        logger.info("GET /api/topologies/{}/nodes - protocol: {}, name: {}, layer: {}, page: {}, size: {}",
                   topologyId, protocol, name, layer, page, size);

        PageResponse<ApiTopologyNode> nodes = apiTopologyService.getTopologyNodes(
                topologyId, protocol, name, layer, page, size);
