...
public class RecordingSettings {
  ...
  public int getTapConcurrent() {
    return tapConcurrent;
  }

  public int getTapReadRetryMaxRetries() {
    return tapReadRetryMaxRetries;
  }

  public long getTapReadRetrySleepMillis() {
    return tapReadRetrySleepMillis;
  }

  public int getCollectionConcurrent() {
    return collectionConcurrent;
  }

  public boolean isDebugExportRawEnabled() {
    return debugExportRawEnabled;
  }
}
