...
public class HybridController {
  ...
  @Autowired private HybridService hybridService;

  /** 启动混合模式（录制 + 拦截） POST /api/hybrid/start */
  @PostMapping("/start")
  public ApiResponse<HybridResponse> start(@Valid @RequestBody StartHybridRequest request) {
    logger.info(
        "POST /api/hybrid/start - namespace: {}, serviceName: {}, recordingRules: {},"
            + " interceptionRules: {}",
  ...
  /** 停止混合模式 POST /api/hybrid/{hybridId}/stop */
  ...
  /** 获取混合模式状态 GET /api/hybrid/{hybridId} */
  @GetMapping("/{hybridId}")
  ...
  /** 添加拦截规则到现有的混合会话 POST /api/hybrid/{hybridId}/interceptions */
  @PostMapping("/{hybridId}/interceptions")
  public ApiResponse<HybridResponse> addInterceptionRules(
      @PathVariable String hybridId, @Valid @RequestBody List<InterceptionRule> rules) {
  ...
  /** 移除拦截规则 DELETE /api/hybrid/{hybridId}/interceptions */
  @DeleteMapping("/{hybridId}/interceptions")
  public ApiResponse<HybridResponse> removeInterceptionRules(
      @PathVariable String hybridId, @RequestBody List<InterceptionRule> rules) {
  ...
  /** 更新拦截规则 PUT /api/hybrid/{hybridId}/interceptions */
  @PutMapping("/{hybridId}/interceptions")
  public ApiResponse<HybridResponse> updateInterceptionRules(
      @PathVariable String hybridId, @Valid @RequestBody List<InterceptionRule> rules) {
  ...
  /** 获取录制数据（与原有录制 API 兼容） GET /api/hybrid/{hybridId}/data */
  @GetMapping("/{hybridId}/data")
  public ApiResponse<List<RecordedEntry>> getRecordedData(
      @PathVariable String hybridId,
