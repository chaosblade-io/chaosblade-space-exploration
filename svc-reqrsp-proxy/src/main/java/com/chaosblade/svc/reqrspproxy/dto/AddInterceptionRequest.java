...
public class AddInterceptionRequest {
    ...
    public AddInterceptionRequest(String namespace, String serviceName, List<InterceptionRule> interceptionRules) {
