...
public class ServiceRequestPattern {
    ...
    public static class RequestMode {
        ...
        public RequestMode(String method, String url, Map<String, String> requestHeaders, String requestBody,
                           Map<String, String> responseHeaders, String responseBody, Integer responseStatus, Long responseTime) {
            this.method = method;
            this.url = url;
