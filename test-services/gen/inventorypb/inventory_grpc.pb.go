...
const (
	InventoryService_CheckStock_FullMethodName = "/inventorypb.InventoryService/CheckStock"
	InventoryService_Deduct_FullMethodName     = "/inventorypb.InventoryService/Deduct"
)
