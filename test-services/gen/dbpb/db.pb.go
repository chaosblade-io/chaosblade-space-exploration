...
type GetResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Value         string                 `protobuf:"bytes,1,opt,name=value,proto3" json:"value,omitempty"` // JSON-encoded string
...
type SetRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Key           string                 `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	Value         string                 `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty"` // JSON-encoded string
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_db_proto_rawDesc = "" +
	...
	"\tDBService\x12*\n" +
	"\x03Get\x12\x10.dbpb.GetRequest\x1a\x11.dbpb.GetResponse\x12*\n" +
	"\x03Set\x12\x10.dbpb.SetRequest\x1a\x11.dbpb.SetResponseB\x18Z\x16test-services/gen/dbpbb\x06proto3"
...
var file_db_proto_goTypes = []any{
	(*GetRequest)(nil),  // 0: dbpb.GetRequest
	(*GetResponse)(nil), // 1: dbpb.GetResponse
	(*SetRequest)(nil),  // 2: dbpb.SetRequest
	(*SetResponse)(nil), // 3: dbpb.SetResponse
}
var file_db_proto_depIdxs = []int32{
	0, // 0: dbpb.DBService.Get:input_type -> dbpb.GetRequest
	2, // 1: dbpb.DBService.Set:input_type -> dbpb.SetRequest
	1, // 2: dbpb.DBService.Get:output_type -> dbpb.GetResponse
	3, // 3: dbpb.DBService.Set:output_type -> dbpb.SetResponse
