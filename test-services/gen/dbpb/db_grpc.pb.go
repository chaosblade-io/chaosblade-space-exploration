...
const (
	DBService_Get_FullMethodName = "/dbpb.DBService/Get"
	DBService_Set_FullMethodName = "/dbpb.DBService/Set"
)
...
//
// DBService simulates a key-value database.
