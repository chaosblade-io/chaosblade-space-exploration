...
/** 系统API列表响应对象 用于封装 /v1/topology/{systemId}/apis 接口的响应数据 */
...
public class SystemApiListResponse {
  ...
  public String toString() {
    return "SystemApiListResponse{" + "success=" + success + ", data=" + data + '}';
  }
  ...
  public static class SystemApiListData {
    ...
    @Override
    public String toString() {
      return "SystemApiListData{" + "items=" + items + ", total=" + total + '}';
    }
  }
