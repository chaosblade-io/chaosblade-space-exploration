...
public class XFlowController {
    ...
    public ResponseEntity<Map<String, Object>> getTopology() {
        try {
            ...
            logger.info("成功返回 XFlow 格式拓扑数据，节点数: {}, 边数: {}",
     ...
     */
    @PostMapping("/layout")
    public ResponseEntity<Map<String, Object>> applyLayout(@RequestBody Map<String, Object> layoutRequest) {
        try {
            ...
            Map<String, Object> layoutedData = xFlowConverterService.applyLayout(algorithm, direction, options);
