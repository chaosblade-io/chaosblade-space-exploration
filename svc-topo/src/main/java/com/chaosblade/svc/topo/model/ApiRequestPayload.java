...
public class ApiRequestPayload {
    ...
    public ApiRequestPayload(String operationId, String rootService, String rootOperation, 
                            String contentType, String headersTemplate, String authType, 
                            String authTemplate, String pathParams, String queryParams, 
                            String bodyTemplate, String variables, Integer timeoutMs, 
                            String retryConfig) {
