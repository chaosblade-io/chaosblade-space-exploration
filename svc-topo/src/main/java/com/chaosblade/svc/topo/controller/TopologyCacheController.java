...
public class TopologyCacheController {
  ...
  public ResponseEntity<Integer> getCacheByTimeIndex(@PathVariable int timeIndex) {
    ...
    try {
      Map<TopologyCacheService.TimeKey, com.chaosblade.svc.topo.model.topology.TopologyGraph>
          cacheItems = topologyCacheService.getByTimeIndex(timeIndex);
