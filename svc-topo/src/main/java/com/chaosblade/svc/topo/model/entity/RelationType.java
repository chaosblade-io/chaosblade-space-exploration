...
/** 关系类型枚举 基于topo_schema_design.md的实体间关系定义 */
public enum RelationType {

  /** 包含关系 - 一个实体包含另一个实体 例如：Namespace包含Service，Service包含Pod 例如：RPCGroup包含RPC */
  CONTAINS("CONTAINS", "contains"),

  /** 依赖关系 - 一个实体依赖另一个实体 例如：Service依赖其他Service、ExternalService或Middleware */
  DEPENDS_ON("DEPENDS_ON", "depends_on"),

  /** 运行关系 - 一个实体运行在另一个实体上 例如：Pod运行在Host上，Instance运行在Host上 */
  RUNS_ON("RUNS_ON", "runs_on"),

  /** 调用关系 - 一个实体调用另一个实体的接口 例如：Service调用RPC接口 */
