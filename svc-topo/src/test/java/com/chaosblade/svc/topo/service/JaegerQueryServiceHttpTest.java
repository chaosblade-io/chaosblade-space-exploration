...
public class JaegerQueryServiceHttpTest {
  ...
  public void testConvertHttpTraceResponse() throws Exception {
    ...
    Method convertMethod =
        JaegerQueryService.class.getDeclaredMethod("convertHttpTraceResponse", String.class);
    ...
    com.chaosblade.svc.topo.model.trace.SpanData.SpanReference reference =
        spanData.getReferences().get(0);
    ...
    com.chaosblade.svc.topo.model.trace.ProcessData processData =
        traceRecord.getProcesses().get("p1");
