...
public class ApiQueryIntegrationTest {
    ...
    void setUp() throws Exception {
        // 从JSON文件加载trace数据
//        ClassPathResource resource = new ClassPathResource("topo-schema/trace-04deae9bf55325ef4cfc39671f85c779.json");
        ClassPathResource resource = new ClassPathResource("topo-schema/trace-2b0b05fdc85d932b5c86887945fb5593.json");
        ...
        for (Node node : topologyFromTrace.getNodes()) {
            System.out.println("节点ID: " + node.getNodeId() + ", 类型: " + node.getEntity().getType() +
                             ", 名称: " + node.getEntity().getDisplayName() +
                             ", appId: " + node.getEntity().getAppId());
        }
        ...
        for (Node node : rpcNodes) {
            System.out.println("RPC节点 - ID: " + node.getNodeId() + ", 名称: " + node.getEntity().getDisplayName() +
                             ", appId: " + node.getEntity().getAppId());
        }
        ...
        for (Node node : serviceNodes) {
            System.out.println("服务节点 - ID: " + node.getNodeId() + ", 名称: " + node.getEntity().getDisplayName() +
                             ", appId: " + node.getEntity().getAppId());
        }
    }
