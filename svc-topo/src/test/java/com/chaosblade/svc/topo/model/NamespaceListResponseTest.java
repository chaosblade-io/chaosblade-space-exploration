...
class NamespaceListResponseTest {
  ...
  void testConstructorWithParameters() {
    // 创建测试数据
    NamespaceDetail detail1 =
        new NamespaceDetail(1L, "train-ticket", "default", "订票系统", "描述1", "admin", "prod");
    NamespaceDetail detail2 =
        new NamespaceDetail(2L, "payment-system", "default", "支付系统", "描述2", "admin", "test");
    List<NamespaceDetail> items = Arrays.asList(detail1, detail2);

    NamespaceListResponse.NamespaceListData data =
        new NamespaceListResponse.NamespaceListData(items, 2);
  ...
  void testSettersAndGetters() {
    ...
    NamespaceDetail detail =
        new NamespaceDetail(1L, "train-ticket", "default", "订票系统", "描述", "admin", "prod");
    List<NamespaceDetail> items = Arrays.asList(detail);
    NamespaceListResponse.NamespaceListData data =
        new NamespaceListResponse.NamespaceListData(items, 1);
